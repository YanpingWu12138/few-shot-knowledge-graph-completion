    ...
    while True:
        ...
        for support_triple in support_triples:
            ...
            while True:
                ...
                if (support_noise not in e1rel_e2[s_h + rel]) and support_noise != s_t:
                    support_noise_list.append(support_noise)
                    break
                else:
                    shift += 1
            support_negative_pairs.append([symbol2id[s_h], symbol2id[support_noise]])
            support_negative_left.append(ent2id[s_h])
            support_negative_right.append(ent2id[support_noise])
        ...
        yield support_pairs, support_negative_pairs, query_pairs, false_pairs, support_left, support_right, support_negative_left, support_negative_right, query_left, query_right, false_left, false_right
