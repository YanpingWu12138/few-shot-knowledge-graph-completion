...
class TransformerEncoder(nn.Module):
    def __init__(self, device,model_dim=100, ffn_dim=800, num_heads=4, dropout=0.1, num_layers=6, max_seq_len=3,
        ...
        self.pos_embedding = PositionalEncoding(model_dim, max_seq_len,self.device)
...
class SoftSelectAttention(nn.Module):
    ...
    def forward(self, support, query):
        ...
        :return:
        """
        query_ = query  # [b, few, dim]
        support_ = support  # [b, few, dim]
        ...
        center = torch.bmm(att, support).squeeze()
        return center
